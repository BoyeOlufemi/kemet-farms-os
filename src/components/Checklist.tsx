...
const initialChecklist: ChecklistItem[] = [
  ...
  // Twilio
  { id: 'tw-1', category: 'twilio', title: 'Join WhatsApp Sandbox', description: 'Send join sandbox message from test phones to +1 415 523 8886.', checked: false },
  ...
  // Verification
  { id: 'v-1', category: 'verification', title: 'Trigger Weather n8n test', description: 'Check if Open-Meteo requests complete with 200 OK and insert weather_triggers.', checked: false },
  { id: 'v-2', category: 'verification', title: 'Receive outbound test', description: 'Check if staff phone receives WhatsApp alerts from the sandbox.', checked: false }
];
