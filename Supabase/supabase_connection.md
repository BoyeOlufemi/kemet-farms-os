-- Kemet Farms OS — Supabase connection info
-- Project ref: ohxjkbpkonfbaalldqqw
-- Apply this schema in the Supabase SQL editor for project ohxjkbpkonfbaalldqqw

CREATE TABLE IF NOT EXISTS kemet_crop_logs (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    field_id TEXT NOT NULL,
    crop_type TEXT NOT NULL CHECK (c_type IN ('PALM', 'SOYBEAN')),
